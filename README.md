...
![P2 routing overview](artifacts/p2/p2-20260904-cpu-five-family-v3/routing-overview.png)
...
The formal CPU run used all four `coco8` validation images. It produced 32 true spatial captures, 80 raw arrays,
128 switchable demo views and 142 manifest-tracked evidence files. MoT and MoA both passed exact repeated-capture
comparison; registered hooks changed model output by a maximum absolute value of `0`.
...
probabilities are invalid, a spatial axis collapses, Top-K indices disagree with MoT sparse weights, repeated
captures differ, hooks leak, or the hooked model output changes.

## Evidence map

- [`summary.json`](artifacts/p2/p2-20260904-cpu-five-family-v3/summary.json): machine-readable verdict and coverage.
- [`family-feasibility.json`](artifacts/p2/p2-20260904-cpu-five-family-v3/family-feasibility.json): five-family runtime decision record.
- [`spatial-routing-raw.npz`](artifacts/p2/p2-20260904-cpu-five-family-v3/spatial-routing-raw.npz): raw probabilities, logits and MoT indices.
- [`spatial-captures.json`](artifacts/p2/p2-20260904-cpu-five-family-v3/spatial-captures.json): array keys, shapes and validation results.
- [`demo.html`](artifacts/p2/p2-20260904-cpu-five-family-v3/demo.html): sample/layer/expert selector and PNG export.
- [`demo-smoke.json`](artifacts/p2/p2-20260904-cpu-five-family-v3/demo-smoke.json): desktop/mobile rendered-browser validation.
- [`manifest.sha256.json`](artifacts/p2/p2-20260904-cpu-five-family-v3/manifest.sha256.json): byte length and SHA-256 for every evidence file.
...
scale, and the UI states this limitation next to every visualization workflow.
